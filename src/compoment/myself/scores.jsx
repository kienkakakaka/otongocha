    ...
    <Modal
      ...
      <div>
        ...
        <div class="mb-3">
          {userScores ? (
            <p className="fw-bold">
              Góp ý, đề xuất: <i>{userScores.input11}</i>
            </p>
          ) : (
            <>
              {" "}
          ...
          {!manager && (
            <>
              {userScores_admin && (
                <p className="fw-bold">
                  Nhận xét của quản lý: <i>{userScores_admin.input11}</i>
                </p>
              )}
            </>
          )}
          {userScores_super_admin && (
            <p className="fw-bold">
              Nhận xét của giám đốc: <i>{userScores_super_admin.input11}</i>
            </p>
          )}
        </div>
